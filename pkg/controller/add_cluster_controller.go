...
//+kubebuilder:rbac:groups=dind.kubekit.cloud,resources=dindclusterproviderspecs;dindclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
