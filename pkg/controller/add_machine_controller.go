...
//+kubebuilder:rbac:groups=dind.kubekit.cloud,resources=dindmachineproviderspecs;dindmachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
